...
class FrameCachedParams:
  ...
  def put(self, key, val, **kwargs):
    self._safe_put(self._cache.put, key, val, **kwargs)

  def put_bool(self, key, val, **kwargs):
    self._safe_put(self._cache.put_bool, key, val, **kwargs)

  def put_int(self, key, val, **kwargs):
    self._safe_put(self._cache.put_int, key, val, **kwargs)

  def put_float(self, key, val, **kwargs):
    self._safe_put(self._cache.put_float, key, val, **kwargs)
