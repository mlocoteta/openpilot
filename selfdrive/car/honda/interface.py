...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    elif candidate in (CAR.ACCORD_NIDEC_4_CYL, CAR.ACCORD_NIDEC_HEV, CAR.ACCORD_NIDEC_6_CYL):
      stop_and_go = False
      ret.mass = 3279. * CV.LB_TO_KG + STD_CARGO_KG
      ret.wheelbase = 2.75
      ret.centerToFront = ret.wheelbase * 0.39
...
#        ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.115], [0.052]]
    ...
    if candidate in (CAR.ACCORD_NIDEC_4_CYL, CAR.ACCORD_NIDEC_HEV, CAR.ACCORD_NIDEC_6_CYL, CAR.ACURA_MDX_HYBRID, CAR.ACURA_MDX):
      ret.steerActuatorDelay = 0.3
