...
def get_can_signals(CP, gearbox_msg, main_on_sig_msg):
  ...
  if CP.carFingerprint == CAR.ODYSSEY_CHN or CAR.ACURA_RLX:
    checks += [
      ("SCM_FEEDBACK", 25),
      ("SCM_BUTTONS", 50),
    ]
  ...
  if CP.carFingerprint in (CAR.ACURA_RLX, CAR.CRV_HYBRID, CAR.CIVIC_BOSCH_DIESEL, CAR.ACURA_RDX_3G, CAR.HONDA_E):
